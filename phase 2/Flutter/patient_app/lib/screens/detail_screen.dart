...
import 'package:shop_app/widgets/progress_widget.dart';
import 'package:shop_app/widgets/rating_star_widget.dart';
                            ...
                            Container(
                              ...
                              child: Icon(
                                ...
                                color: Colors.white,
                                  ...
                                  () {Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => ChatDetailPage(name:  model.name,imageUrl: model.image)),
                                  );},
                              borderRadius: BorderRadius.circular(10),
                            ),
                            SizedBox(
